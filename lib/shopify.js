...
export async function bestSellingData(){
  const query = `
  {
    collectionByHandle(handle:"frontpage"){
      title
  ...
  const best_products = response.data.collectionByHandle.products.edges ? response.data.collectionByHandle.products.edges : []
